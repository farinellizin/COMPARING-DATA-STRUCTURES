...
void runRedBlackTree() {
    ...
    cout << "time insert 500: " << rb500 << endl;
    cout << "time insert 5000: " << rb5000 << endl;
    cout << "time insert 50000: " << rb50000 << endl;
    cout << "time insert 500000: " << rb500000 << endl;

    cout << endl << endl << endl;

    cout << rbRemove500 << rbRemove5000 << rbRemove50000 << rbRemove500000 << endl;
