...
void runUnorderedMap() {
    ...
    float umSearch500, umSearch5000, umSearch50000, umSearch500000;
    ...
    umSearch500 = searchInUnorderedMap(umap500);
    umSearch5000 = searchInUnorderedMap(umap5000);
    umSearch50000 = searchInUnorderedMap(umap50000);
    umSearch500000 = searchInUnorderedMap(umap500000);
 ...
 um50000, umRemove50000, umRemoveCont50000, um500000, umRemove500000, umRemoveCont500000, umSearch500, umSearch5000, umSearch50000, umSearch500000);
} 